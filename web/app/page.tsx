      ...
      <main className="flex-1 pt-20">
        ...
        <section className="relative py-16 lg:py-24 bg-background">
          <div className="container mx-auto px-4">
            ...
            {/* Search Bar */}
            <div className="max-w-5xl mx-auto bg-card border border-border/50 rounded-full shadow-xl p-2 flex flex-col md:flex-row items-center gap-2">
              ...
              <div className="flex-1 w-full md:w-auto relative group">
                ...
                <div className="flex flex-col px-12 py-2 w-full hover:bg-secondary/50 rounded-full transition-colors cursor-pointer">
                  <span className="text-xs font-bold text-foreground">Guests</span>
                  <input
                    type="text"
              ...
              <Button size="lg" className="rounded-full h-14 w-full md:w-auto px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-md">
                Search
              </Button>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="group p-8 rounded-2xl bg-background border border-border/50 hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 relative overflow-hidden">
                  ...
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-primary/10 mb-6 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
